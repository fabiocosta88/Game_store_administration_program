...
CheckPagina($_SESSION['ni_user'], 1);
?>
...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="contentLine">
            <a style="text-align: left">Painel de <strong>Funcionario!</strong></a>
        <?php 
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <?php
                        IMPlistaVendas($_SESSION['email'],"../MODEL/PHP files/DAOMovimento_Geral.php","../MODEL/PHP files/DAOProdutos.php");
                        ?>
                    </div>
                </div>
